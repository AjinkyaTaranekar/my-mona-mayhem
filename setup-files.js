...
fs.writeFileSync(githubFile, githubContent, 'utf8');
console.log('Created file:', githubFile);

// Update [username].ts
const apiFile = path.join(__dirname, 'src', 'pages', 'api', 'contributions', '[username].ts');
